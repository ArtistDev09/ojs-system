<?php
/* Smarty version 4.3.1, created on 2025-12-19 02:19:57
  from 'app:controllersgridusersstageParticipantaddParticipantForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6944a83dbf5c44_05984284',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ab1597004e611fd0a9d0d6dc376fc76586701af5' => 
    array (
      0 => 'app:controllersgridusersstageParticipantaddParticipantForm.tpl',
      1 => 1732910728,
      2 => 'app',
    ),
  ),
...
function content_6944a83dbf5c44_05984284 (Smarty_Internal_Template $_smarty_tpl) {
 ...
 type="text/javascript">
	$(function() {
		...
		$('#addParticipantForm').pkpHandler('$.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler',
			{
				possibleRecommendOnlyUserGroupIds: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['possibleRecommendOnlyUserGroupIds']->value ));?>
,
				recommendOnlyUserGroupIds: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['recommendOnlyUserGroupIds']->value ));?>
,
				anonymousReviewerIds: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['anonymousReviewerIds']->value ));?>
,
				anonymousReviewerWarning: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['anonymousReviewerWarning']->value ));?>
,
				anonymousReviewerWarningOk: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['anonymousReviewerWarningOk']->value ));?>
,
				templateUrl: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>(defined('ROUTE_COMPONENT') ? constant('ROUTE_COMPONENT') : null),'component'=>'grid.users.stageParticipant.StageParticipantGridHandler','op'=>'fetchTemplateBody','stageId'=>$_smarty_tpl->tpl_vars['stageId']->value,'submissionId'=>$_smarty_tpl->tpl_vars['submissionId']->value,'escape'=>false),$_smarty_tpl ) ) ));?>
,
				notChangeMetadataEditPermissionRoles: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['notPossibleEditSubmissionMetadataPermissionChange']->value ));?>
,
				permitMetadataEditUserGroupIds: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['permitMetadataEditUserGroupIds']->value ));?>
...
" />
		<input type="hidden" name="assignmentId" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( (($tmp = $_smarty_tpl->tpl_vars['assignmentId']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp) ));?>
" />
...
while ($_block_repeat) {
ob_start();?>
				<b><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['currentUserName']->value ));?>
</b> (<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['currentUserGroup']->value ));?>
)
