...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6930dc54551b50_67137726',
...
function content_6930dc54551b50_67137726 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
?>
	...
	<div id="submission-files-container">
		...
		<?php echo '<script'; ?>
 type="text/javascript">
			pkp.registry.init('submission-files-container', 'Container', <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['state']->value ));?>
);
		<?php echo '</script'; ?>
>
	</div>
