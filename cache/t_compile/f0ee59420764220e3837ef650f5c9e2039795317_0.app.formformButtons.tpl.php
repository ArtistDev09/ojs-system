...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6902ce03db3ff9_65015146',
...
function content_6902ce03db3ff9_65015146 (Smarty_Internal_Template $_smarty_tpl) {
...
ob_start();?>
		...
		<?php $_smarty_tpl->_assignInScope('submitButtonId', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'uniqid' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( "submitFormButton","-" )) )));?>
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"submit",'class'=>$_prefixVariable1." submitFormButton",'name'=>"submitFormButton",'id'=>$_smarty_tpl->tpl_vars['submitButtonId']->value,'label'=>$_smarty_tpl->tpl_vars['FBV_submitText']->value,'translate'=>$_smarty_tpl->tpl_vars['FBV_translate']->value,'disabled'=>$_smarty_tpl->tpl_vars['FBV_submitDisabled']->value),$_smarty_tpl ) );?>
		...
		<?php $_smarty_tpl->_assignInScope('saveButtonId', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'uniqid' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( "saveFormButton","-" )) )));?>
	...
	<?php }?>
		...
		<?php $_smarty_tpl->_assignInScope('cancelButtonId', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'uniqid' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( "cancelFormButton","-" )) )));?>
